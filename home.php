  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Twitter is developed by <span style="font-weight: 700;">FCAIH Team</span>  for learning purpose.</p>
        ...
        <p>By default you followed
          <a style="color:#207ce5;" href="youssef_112">@youssef_112</a> 
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/includes/icons/home.png"; ?>" alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <img
                src="<?php echo BASE_URL . "/includes/icons/bell.png"; ?>"
                alt=""
                height="26.25px"
                width="26.25px"
              />
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/includes/icons/user.png"; ?>" alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/includes/icons/settings.png"; ?>" alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <a href="home.php"><strong>Tweet</strong></a>
          </button>
              ...
              <div class="input-group-login" id="whathappen">
                ...
                <div class="container">
                  <div class="part-1">
                    ...
                    <div class="text">
                      <form class="" action="controllar/handleTweet.php" method="post" enctype="multipart/form-data">
                        <div class="inner">
