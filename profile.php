               ...
               <div class="container">
                 ...
                 <div class="row justify-content-between">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <form method="POST" action="controllar/handleUpdateData.php" enctype="multipart/form-data">
                            ...
                            <div class="image-upload">
                                ...
                                <i style="top: 80px;
                                 ...
                                 font-size:18px " class="far fa-images position-absolute"></i> 
                                  ...
                                  <a href="controllar/handleDeleteCover.php" style="top: 80px;
                                 left:260px;
                                 color:red;
                  ...
                  <div class="home-title">
                    ...
                    <p class="user-controllar" style="color: gray;">@<?php echo $profileData->username; ?>
